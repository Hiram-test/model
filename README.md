...
- [`docs/geometry-assembly-long-run-design-2026-07-22.md`](docs/geometry-assembly-long-run-design-2026-07-22.md)：将人工逐件装配过程转化为自动连续运行的工作包、检查点、代理细化、独立视觉复核和防退化流程。
- [`docs/geometry-assembly-long-run.example.yaml`](docs/geometry-assembly-long-run.example.yaml)：几何专用长任务状态机、阶段 Gate、代理生命周期、逐构件回执和 hook 扩展示例。
