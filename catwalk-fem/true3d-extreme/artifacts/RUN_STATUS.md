...
Known deviations kept this run: solved COARSEN=4 deck still has 63 passage x-stations; builder now clusters them to 21 equivalent beams (rebuild S3 to apply). LS2 locked-rule pair is the next main-span L+S at 0.209 Hz (ratio 1.92 to attach 0.1087, half-waves=5); no re-pair. LS1 is +9.1%. COARSEN=2 T-shift ledger is in `coarsen2_shift.json` (TA1/TS1 −1.4%/−1.1%).
