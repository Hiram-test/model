...
- 运行：`C10_A0_DIRECT_SPATIAL_RAMP_20260802T040827007333Z`；job：`cw_C10a0_0802t040827007333_d1`。
...
- 资源门：启动和监控统一为 24 GiB 空盘；依据为历史最大 C10 失败/NRRE 包 5.630 GiB 的约 4.26 倍，本轮参考空余下另留约 14.653 GiB。
